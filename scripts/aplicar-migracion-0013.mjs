/**
 * Script: aplica la migración SQL 0013 en Neon.
 */
...
const archivo = readFileSync(
  join(__dirname, "..", "drizzle", "0013_simplificar_roles.sql"),
  "utf8"
);
...
console.log("Migración 0013 aplicada (roles USUARIO / ADMINISTRADOR).");
