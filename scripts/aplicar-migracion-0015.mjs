/**
 * Script: aplica la migración SQL 0015 en Neon.
 */
...
const archivo = readFileSync(
  join(__dirname, "..", "drizzle", "0015_eliminar_microchip.sql"),
  "utf8"
);
...
console.log("Migración 0015 aplicada (columna microchip eliminada).");
