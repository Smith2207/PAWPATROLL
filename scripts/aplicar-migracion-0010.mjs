/**
 * Script: aplica la migración SQL 0010 en Neon.
 */
...
const archivo = readFileSync(
  join(__dirname, "..", "drizzle", "0010_notificaciones_casos.sql"),
  "utf8"
);
...
console.log("Migración 0010 aplicada (notificaciones, casos, abusos).");
