...
const CARACTERISTICAS: {
...
}[] = [
  {
    ...
    desc: "Compara una imagen con mascotas perdidas usando similitud visual (IA). Sirve para orientar un avistamiento; la confirmación la hace la comunidad.",
  },
  {
    clase: "fc-blue",
    iconoClase: "fi-bl",
    ...
    desc: "Mapa comunitario con zona de búsqueda por mascota y avistamientos; en cada mascota, mapa propio con refugios probables y guía de búsqueda.",
  },
  {
    clase: "fc-blue",
    iconoClase: "fi-bl",
    ...
    desc: "Consejos según raza y tamaño, radio de búsqueda que crece con el tiempo y puntos de refugio probables en la página de cada mascota.",
  },
  {
    clase: "fc-yellow",
    iconoClase: "fi-ye",
    ...
    desc: "Cuando un avistamiento se vincula a una mascota, el dueño recibe un correo (si SMTP está configurado). Puedes verificar o descartar reportes en su página.",
  },
  {
    clase: "fc-purple",
    iconoClase: "fi-pu",
    ...
    desc: "Mensajes por cada reporte entre dueño y quien avistó. El mapa se actualiza al instante en local y se refresca automáticamente en producción.",
  },
  {
    clase: "fc-red",
    iconoClase: "fi-re",
